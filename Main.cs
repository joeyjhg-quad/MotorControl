...
namespace MotorControl
{
    public partial class Main : Form
    {
        ...
        {
            Logger.LogDebug("FormClosing Start");
            threadManager.Stop();
            ...
            Logger.LogDebug("FormClosing End");
        }
        private void BFX_Connect()
        {
            try
            {
                Logger.LogDebug("BFX_Connect Start");
                // gRPC 채널 생성
                ...
                BFXConnect = true;
                Logger.LogDebug("BFX_Connect End");
            }
            catch (Exception e)
            {
        ...
        private void InitializeSerialPort()
        {
            try
            {
                Logger.LogDebug("InitializeSerialPort Start");
                ...
                Logger.LogDebug("InitializeSerialPort End");
            }
            catch (Exception e)
            {
                Logger.LogError(e.Message);
        ...
        private void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            try
            {
                ...
                Logger.LogDebug("수신 데이터: " + receivedData);
                ...
                if (receivedData.StartsWith("R1") && receivedData.Length >= 4)
                {
                    ...
                    {
                        Logger.LogError("16진수 변환 실패: " + hexValue);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void btn_SpeedSetUp_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Logger.LogDebug("btn_SpeedSetUp_Click Start");
                if (uint.TryParse(tb_Speed_Target.Text, out uint speed) && ushort.TryParse(tb_Tca_Target.Text, out ushort tca) && ushort.TryParse(tb_Tcd_Target.Text, out ushort tcd))
                {
                    ...
                    Logger.LogDebug("btn_SpeedSetUp_Click End");
                }
                else
                {
                    Logger.LogError("알맞은 값 확인");
        ...
        private void btn_PositionMove_Click(object sender, EventArgs e)
        {
            ...
            Logger.Log("PositionMove_Click Start");
            ...
            Logger.Log("PositionMove_Click End");
        }
        ...
        {
            Logger.LogDebug("btn_Expanded_Click");
            // isExpanded 상태 토글
        ...
        {
            Logger.LogDebug("btn_Fullscreen_Click");
        ...
        {
            Logger.LogDebug("Position_Move Start");
            if (threadManager.IsWorkerRunning())
            {
                MessageBox.Show("작업 중");
                return;
        ...
        {
            Logger.LogDebug("Position_Save Start");
            if (sender is System.Windows.Forms.Button button && button.Tag is string tagValue)
            {
                int num = int.Parse(tagValue);
                string dx, dy, dz;
            ...
            Logger.LogDebug("Position_Save End");
        ...
        {
            Logger.LogDebug("btn_ImgProcessing_Click");
            ...
            threadManager.AddWorkerTask((token) =>
            {
                try
                {
                    ...
                    Logger.LogDebug($"x {currentPosition[0]} y {currentPosition[1]} z {currentPosition[2]} target");
        ...
        {
            Logger.LogDebug("btn_ExpansionCustom_Click");
        ...
        {
            Logger.LogDebug("btn_ChangeJogMode_Click");
            // isExpanded 상태 토글
            isJogMode = !isJogMode;
        ...
        private void btn_Distance_Setting_Click(object sender, EventArgs e)
        {
            ...
            Logger.Log("XY Distance_Setting Start");
            ...
            btn_Distance_OK.Enabled = true;
            Logger.Log("XY Distance_Setting End");
        }
        private void btn_Distance_Setting_Auto_Click(object sender, EventArgs e)
        {
            ...
            Logger.Log("Distance_Setting_Auto_Click");
            int pX = int.Parse(tb_Dispensing_FirstX.Text);
            int pY = int.Parse(tb_Dispensing_FirstY.Text);
            int pZ = int.Parse(tb_Dispensing_FirstZ.Text);
            int pX2 = int.Parse(tb_Dispensing_Cam_X.Text);
        ...
        private void btn_Distance_OK_Click(object sender, EventArgs e)
        {
            ...
            tb_Distance_Y.Text = (int.Parse(tb_Dispensing_FirstY.Text) - int.Parse(tb_Dispensing_Cam_Y.Text)).ToString();
            tb_Distance_Z.Text = tb_Dispensing_FirstZ.Text;
            Logger.Log("Distance Setting OK");
        }
        ...
        private void btn_Dispencing_Timer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dpTimer.Enabled)
                {
                    Logger.LogDebug("interval change");
                    return;
                }
                dpTimer.Start();
        ...
        private void btn_Lamp_Change_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Logger.LogError("시리얼 포트가 열려 있지 않습니다.");
                    return;
                }
            ...
            {
                Logger.LogError("송신 오류: " + ex.Message);
            }
        }
